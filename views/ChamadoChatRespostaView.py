...
from interface.chamado_chat_resposta import Ui_Form


class ChamadoChatRespostaView(View, Ui_Form):
    ...
    def get_titulo(self):
        titulo = self._dados["name"].split("/")
        return titulo[0]

    def preencher_inicio(self):
        self.lb_titulo.setText(self.get_titulo())
